...
import ru.mobileup.template.features.generated.resources.dialogs_custom_dialog_button
import ru.mobileup.template.features.generated.resources.dialogs_dismissible_sheet_button
import ru.mobileup.template.features.generated.resources.dialogs_message_sheet_button
import ru.mobileup.template.features.generated.resources.dialogs_non_dismissible_sheet_button
import ru.mobileup.template.features.generated.resources.dialogs_standard_dialog_button
import ru.mobileup.template.features.generated.resources.dialogs_title
...
fun DialogsUi(
    ...
    Scaffold(
        ...
        topBar = {
            AppToolbar(
                title = stringResource(Res.string.dialogs_title),
                showBackButton = true
            )
        }
    ) { innerPadding ->
...
private fun DialogsContent(
    ...
    Column(
        ...
        AppButton(
            ...
            text = stringResource(Res.string.dialogs_standard_dialog_button),
        ...
        AppButton(
            modifier = Modifier.fillMaxWidth(),
            text = stringResource(Res.string.dialogs_custom_dialog_button),
        ...
        AppButton(
            modifier = Modifier.fillMaxWidth(),
            text = stringResource(Res.string.dialogs_dismissible_sheet_button),
            buttonType = ButtonType.Primary,
        ...
        AppButton(
            modifier = Modifier.fillMaxWidth(),
            text = stringResource(Res.string.dialogs_non_dismissible_sheet_button),
            buttonType = ButtonType.Secondary,
        ...
        AppButton(
            modifier = Modifier.fillMaxWidth(),
            text = stringResource(Res.string.dialogs_message_sheet_button),
            buttonType = ButtonType.Primary,
...
@Composable
private fun DialogsBottomSheetContent(
    data: DialogsBottomSheetData,
    onCancelClick: () -> Unit,
