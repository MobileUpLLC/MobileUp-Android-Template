...
class RealSettingsComponent(
    ...
    private val regularSettings = settingsFactory.getSettings("settings_regular")
    private val encryptedSettings = settingsFactory.getEncryptedSettings("settings_encrypted")
    ...
    private fun SettingsUiState.section(storageType: SettingsStorageType): SettingsSectionUiState =
        when (storageType) {
